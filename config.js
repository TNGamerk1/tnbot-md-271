...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'TNBoT-MD',
    ...
    BOT_INFO: process.env.BOT_INFO || 'null',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'null' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'TNBoT-MD;TNGAMERK1' : process.env.STICKER_DATA,
